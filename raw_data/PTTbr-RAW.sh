...
###--- problems due to timeout on telnet: CE, CPV, DF, GYN, MG, PE, RS, VIX

for code in ${pub_ixp}; do
  (echo "term l 0"; sleep 1; echo "show ip bgp"               ; sleep 8m; echo "exit";) | telnet lg.${code}.ptt.br | tee lg.${code}.ptt.br-BGP-IPv4.txt
