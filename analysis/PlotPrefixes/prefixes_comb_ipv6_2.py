...
for file in files:
    ...
    ax1.plot(x, [yi * 100 / sum(y) for yi in y], markersize=GRAPH_MARKER_SIZE,
             color=color,
             linestyle=linestyle,
             marker=marker,
...
xlim_max += 1
ticks_x = np.arange(xlim_min - 1, xlim_max + 1, 1)
...
# ax2.set_ylim(ylim_min - 50, ylim_max + 100000)
...
# Save of file
fig_name = "rib_" + INPUT_FOLDER + "_ipv6_all_graph.eps"
